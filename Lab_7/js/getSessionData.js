...
let lat_max = sessionStorage.getItem("lat_max"); // Your code here
let lat_min = sessionStorage.getItem("lat_min"); // Your code here
let lon_max = sessionStorage.getItem("lon_max"); // Your code here
let lon_min = sessionStorage.getItem("lon_min"); // Your code here
