...
let p1Element = document.getElementsByClassName("p1")[0]; 
p1Element.textContent = "my name has " + myFullName.match(/[a-z]/gi).length + " characters";
// 4 & 5 Into the second paragraph tag, return the 3rd character in your first name
let p2Element = document.getElementsByClassName("p2")[0];
...
p2Element.appendChild(document.createTextNode(myFullName.substring(myFullName.length - 3, myFullName.length)));
// 8 Substring your first and last name into two separate variables
let firstName = myFullName.substring(0, myFullName.indexOf(' '));
let lastName = myFullName.substring(myFullName.indexOf(' ') + 1, myFullName.length);
...
headerDiv.textContent = originalHeaderArray[0] + " " + originalHeaderArray[1] + " " + totalLength + " " + originalHeaderArray[2] + " " +originalHeaderArray[3]; 